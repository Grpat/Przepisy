...
namespace Hostele.Controllers
{
    ...
    public class IngredientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IngredientName,Carbohydrates,Protein,Fat,Kcal")] Ingredients ingredients)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IngredientName,Carbohydrates,Protein,Fat,Kcal")] Ingredients ingredients)
        {
