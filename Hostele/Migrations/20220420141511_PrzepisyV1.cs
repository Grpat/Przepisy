...
{
    /// <inheritdoc />
    public partial class PrzepisyV1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Carbohydrates = table.Column<decimal>(type: "decimal(5,1)", nullable: true),
                    Protein = table.Column<decimal>(type: "decimal(5,1)", nullable: true),
                    Fat = table.Column<decimal>(type: "decimal(5,1)", nullable: true),
                    Kcal = table.Column<decimal>(type: "decimal(5,1)", nullable: true)
                },
                constraints: table =>
                {
