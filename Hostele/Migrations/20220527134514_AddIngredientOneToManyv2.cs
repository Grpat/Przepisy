...
{
    /// <inheritdoc />
    public partial class AddIngredientOneToManyv2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Carbohydrates = table.Column<decimal>(type: "decimal(5,1)", nullable: false),
                    Protein = table.Column<decimal>(type: "decimal(5,1)", nullable: false),
                    Fat = table.Column<decimal>(type: "decimal(5,1)", nullable: false),
                    Kcal = table.Column<decimal>(type: "decimal(5,1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(5,1)", nullable: false),
                    MeasureNumber = table.Column<int>(type: "int", nullable: false),
                    Measure = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ingrds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Ingrds_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
